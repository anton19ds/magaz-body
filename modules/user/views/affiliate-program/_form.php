...
<div class="popup add_promocode_popup" id="promocodeAddPopup">
    ...
    <div class="form_add_promocode__input nick_new_promocode">
        ...
        <div class="nick_new_promocode__inp">
            <input type="text" id="name_new_promocode" name="newPromocode[name_new_promocode]">
        ...
        <div class="nick_new_promocode__result">
            ...
            <p>
                anticandida.com/<?= $lang?>/p/<span class="result_nick_promocode"></span>
            </p>
        </div>
    </div>
    <div class="form_add_promocode__input target_link_promocode">
        ...
        <div class="target_link_promocode__inp">
            <input type="text" id="link_new_promocode" name="newPromocode[link_new_promocode]">
        </div>
    </div>
            ...
            <div class="promocode_percents__line">
                <div class="promocode_percents__group">
                    <div class="promocode_percents_line__mob">
                        ...
                        <?= Yii::t('app', "promo-desc-21")?>: <?= CategoryPromo::getName($sizeLavel['category_promo_id'])?> (<?= $sizeLavel['size']?>%)
                    </div>
                    <span><?= CategoryPromo::getName($sizeLavel['category_promo_id'])?> (<?= $sizeLavel['size']?>%):</span>
                </div>
                <div class="promocode_percents__sale-clients">
                    <div class="promocode_percents_line__mob">
                        <span class="promocode_question">
                    ...
                    <p><input type="number" name="newPromocode[<?= CategoryPromo::getTag($sizeLavel['category_promo_id'])?>][2]" data-summ="<?= $sizeLavel['size']?>" group_percent="<?= $sizeLavel['id']?>" value="0"></p>
                </div>
                <div class="promocode_percents__you-prize">
                    <div class="promocode_percents_line__mob">
                        <span class="promocode_question">
                    ...
                    <p><input type="number" name="newPromocode[<?= CategoryPromo::getTag($sizeLavel['category_promo_id'])?>][1]" data-summ="<?= $sizeLavel['size']?>" group_percent="<?= $sizeLavel['id']?>" value="0"></p>
                </div>
...
<style>
    .target_link_promocode__inp:before {
        content: 'anticandida.com/';
    }
