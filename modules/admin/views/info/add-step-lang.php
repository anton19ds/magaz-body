...
debug($parent->category_id);
?>

<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
<?= $form->field($model, 'sort')->hiddenInput(['value' => $parent->sort])->label(false) ?>
<?= $form->field($model, 'info_id')->hiddenInput(['value' => $parent->id])->label(false) ?>
<?= $form->field($model, 'img')->hiddenInput(['value' => $parent->img])->label(false) ?>
<?= $form->field($model, 'tag')->hiddenInput(['value' => $lang])->label(false) ?>
<?= $form->field($model, 'category_id')->hiddenInput(['value' => $parent->category_id])->label(false) ?>
...
$(".success-articles").on("click", function(e){
  e.preventDefault();
  var id = $("#infosteplang-content").val();
  ArticlesGet(id);
});
