...
<div id="page-magazin">
    ...
    <div class="left-block">
        ...
        <div class="order-form-cart">
            <a href="/<?= $currensy ?>/login" class="link-login">Есть аккаунт?</a>
                ...
                <div class="form-contact-cart-order">
                    ...
                    <div class="card-set-el">
                        <div class="block-form-cart-left">
                            ...
                            <div class="cart-field">
                                <input type="text" name="UserAdress[area]" onkeypress="validate(event)" placeholder=""
                                    value="">
                        ...
                        <div class="block-form-cart-right">
                            <div class="cart-field">
                                <input type="text" name="UserAdress[city]" onkeypress="validate(event)" placeholder="" class="requered">
                    ...
                    <div class="card-set-el">
                        <div class="col-s-1">
                            <div class="cart-field">
                                <input type="text" name="User[firstName]" onkeypress="validate(event)" placeholder="" class="requered">
                                <label class="set-label">Фамилия</label>
                            </div>
                        </div>
                        <div class="col-s-1">
                            <div class="cart-field">
                                <input type="text" name="User[LastName]" onkeypress="validate(event)" placeholder="" class="requered">
                                <label class="set-label">Имя</label>
                            </div>
                        </div>
                        <div class="col-s-1">
                            <div class="cart-field">
                                <input type="text" name="User[secondName]" onkeypress="validate(event)" placeholder="">
